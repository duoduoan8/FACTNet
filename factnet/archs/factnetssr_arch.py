...
from factnet.archs.local_arch import Local_Base
from basicsr.archs.arch_util import trunc_normal_
from factnet.archs.factnet_utils import HAB, OCAB, window_partition, SFB
from factnet.archs.factnet_utils import PatchEmbed, PatchUnEmbed, Upsample
...
class FACTNetSSR(nn.Module):
    def __init__(self,
                 ...
                 **kwargs):
        super(FACTNetSSR, self).__init__()
...
@ARCH_REGISTRY.register()
class FACTNetSSR_Local(Local_Base, FACTNetSSR):
    def __init__(self, *args, train_size=(1, 6, 64, 64), fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        FACTNetSSR.__init__(self, *args, **kwargs)
...
if __name__ == '__main__':
    net = FACTNetSSR(upscale=4, in_chans=3, img_size=64, window_size=16, compress_ratio=3, squeeze_factor=30,
