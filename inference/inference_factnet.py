...
from factnet.archs.hatfir_arch import HATFIR


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--input', type=str, default='datasets/Set5/LRbicx4', help='input test image folder')
    parser.add_argument('--output', type=str, default='results/FACTNet/Set5', help='output folder')
    parser.add_argument('--task', type=str, default='FACTNet', help='FACTNet, FACTNet-T, HATFIR, HATFIR-L')
    ...
    parser.add_argument('--model_path', type=str, default='experiments/pretrained_models/FACTNet/FACTNet_SRx4.pth')
