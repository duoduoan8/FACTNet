...
from factnet.archs.factnetssr_arch import FACTNetSSR, FACTNetSSR_Local


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--input', type=str, default='datasets/Flickr1024/lr_x4', help='input test image folder')
    parser.add_argument('--output', type=str, default='results/FACTNetSSR/Set5', help='output folder')
    parser.add_argument('--task', type=str, default='FACTNetSSR_Local', help='FACTNetSSR, FACTNetSSR_Local')
    ...
    parser.add_argument('--model_path', type=str,
                        default='experiments/pretrained_models/FACTNetSSR/FACTNetSSR_SSRx4.pth')
...
def define_model(args):
    ...
    elif args.task == 'FACTNetSSR_Local':
        model = FACTNetSSR_Local(
            upscale=args.scale,
            in_chans=3,
            img_size=args.training_patch_size,
            window_size=16,
